...
function DorionSettingsTab() {
    ...
    return (
        <SettingsTab title="Dorion Settings">
            ...
            <Forms.FormSection title="Startup" className={Margins.top16}>
                <Switch
                    value={state.open_on_startup}
                    onChange={v => setState({
                        ...state,
                        open_on_startup: v,
                    })}
                ...
                <Switch
                    value={state.startup_minimized}
                    disabled={!state.open_on_startup}
                    onChange={v => setState({
                        ...state,
                        startup_minimized: v,
                    })}
            ...
            <Forms.FormSection title="Misc." className={Margins.top16}>
                ...
                <Switch
                    value={state.update_notify === undefined || state.update_notify}
                    onChange={v => setState({
                        ...state,
                        update_notify: v,
                    })}
