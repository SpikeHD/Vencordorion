...
async function loadBadges(noCache = false) {
    ...
    const badges = await fetch("https://127.0.0.1:8678/url?url=https://gist.githubusercontent.com/Vendicated/51a3dd775f6920429ec6e9b735ca7f01/raw/badges.csv", init)
        .then(r => r.text());
